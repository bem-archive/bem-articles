...
<div class="article-author" style="width: 50%; float: left;">
    <div class="article-author__photo">
        <img class="article-author__pictures" src="http://img-fotki.yandex.ru/get/6434/51437929.0/0_bfef0_5d9cdb30_M.jpg" alt="A photo of Vladimir Varankin">
    </div>
    <div class="article-author__info">
        <div class="article-author__row">
             <span class="article-author__name">Vladimir Varankin,
        </div>
        <div class="article-author__row">
            Lead Interface Developer, Yandex
        </div>
        <div class="article-author__row">
...
<div class="article-author" style="width: 50%; float: left;">
    <div class="article-author__photo">
        <img class="article-author__pictures" src="http://img-fotki.yandex.ru/get/9516/204961608.0/0_9ea64_6886d41e_S.jpg" alt="A photo of Paul Bashinsky">
    </div>
    <div class="article-author__info">
        <div class="article-author__row">
             <span class="article-author__name">Paul Bashinsky,
        </div>
        <div class="article-author__row">
            Project Manager, Yandex
        </div>
        <div class="article-author__row">
             <a class="article-author__social-icon b-link" target="_blank" href="https://twitter.com/pavel_bashinsky">twitter.com/pavel_bashinsky</a>
        </div>
        <div class="article-author__row">
             <a class="article-author__social-icon b-link" target="_blank" href="https://github.com/levonet">github.com/levonet</a>
        </div>
    </div>
</div>
